...
QT_MOC_LITERAL(4, 30, 15), // "terminalResized"
QT_MOC_LITERAL(5, 46, 4), // "rows"
QT_MOC_LITERAL(6, 51, 4) // "cols"

    },
    "TerminalWidget\0sendData\0\0data\0"
    "terminalResized\0rows\0cols"
};
...
void TerminalWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->terminalResized((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TerminalWidget::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TerminalWidget::sendData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TerminalWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TerminalWidget::terminalResized)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TerminalWidget::sendData(const QByteArray & _t1)
{
...
// SIGNAL 1
void TerminalWidget::terminalResized(int _t1, int _t2)
{
